public class Bank {
    ...
    double moneytransfer(double amount){
         ...
         if (balance >= amount) {
             ...
             System.out.println("Amount of Rs."+ amount + " is credited to your account number-" +Account_number2 + ". Your available balance is Rs." + receiver_balance);
             return balance;
         } else {
        ...
        public static void main (String[] args){
            ...
            if (action == 1) {
                ...
                System.out.println("Invalid action. Please try again with correct input.");
            }
        }
    }